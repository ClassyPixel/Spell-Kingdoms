...
export const SUMMON_CARD_DECK = [
  // Cost 2 (×2)
  { cardId: 'sum_imp',       type: 'summon', name: 'Fire Imp',       hp: 7, power: 9, summonCost: 2,  art: '👺' },
  { cardId: 'sum_wisp',      type: 'summon', name: 'Arcane Wisp',    hp: 9, power: 7, summonCost: 2,  art: '✨' },
  // Cost 3 (×4)
  { cardId: 'sum_sprite',    type: 'summon', name: 'Frost Sprite',   hp: 8, power: 5, summonCost: 3,  art: '🧊' },
  { cardId: 'sum_bat',       type: 'summon', name: 'Shadow Bat',     hp: 5, power: 8, summonCost: 3,  art: '🦇' },
  { cardId: 'sum_sprite',    type: 'summon', name: 'Frost Sprite',   hp: 8, power: 5, summonCost: 3,  art: '🧊' },
  { cardId: 'sum_bat',       type: 'summon', name: 'Shadow Bat',     hp: 5, power: 8, summonCost: 3,  art: '🦇' },
  // Cost 4 (×5)
  { cardId: 'sum_shaman',    type: 'summon', name: 'Earth Shaman',   hp: 7, power: 5, summonCost: 4,  art: '🌿' },
  { cardId: 'sum_hawk',      type: 'summon', name: 'Storm Hawk',     hp: 5, power: 7, summonCost: 4,  art: '🦅' },
  { cardId: 'sum_shaman',    type: 'summon', name: 'Earth Shaman',   hp: 7, power: 5, summonCost: 4,  art: '🌿' },
  { cardId: 'sum_hawk',      type: 'summon', name: 'Storm Hawk',     hp: 5, power: 7, summonCost: 4,  art: '🦅' },
  { cardId: 'sum_hawk',      type: 'summon', name: 'Storm Hawk',     hp: 5, power: 7, summonCost: 4,  art: '🦅' },
  // Cost 5 (×5)
  { cardId: 'sum_bear',      type: 'summon', name: 'Forest Bear',    hp: 6, power: 4, summonCost: 5,  art: '🐻' },
  { cardId: 'sum_djinn',     type: 'summon', name: 'Fire Djinn',     hp: 4, power: 6, summonCost: 5,  art: '🌋' },
  { cardId: 'sum_bear',      type: 'summon', name: 'Forest Bear',    hp: 6, power: 4, summonCost: 5,  art: '🐻' },
  { cardId: 'sum_djinn',     type: 'summon', name: 'Fire Djinn',     hp: 4, power: 6, summonCost: 5,  art: '🌋' },
  { cardId: 'sum_bear',      type: 'summon', name: 'Forest Bear',    hp: 6, power: 4, summonCost: 5,  art: '🐻' },
  // Cost 6 (×6)
  { cardId: 'sum_sentinel',  type: 'summon', name: 'Stone Sentinel', hp: 5, power: 4, summonCost: 6,  art: '🗿' },
  { cardId: 'sum_fox',       type: 'summon', name: 'Lightning Fox',  hp: 4, power: 5, summonCost: 6,  art: '🦊' },
  { cardId: 'sum_sentinel',  type: 'summon', name: 'Stone Sentinel', hp: 5, power: 4, summonCost: 6,  art: '🗿' },
  { cardId: 'sum_fox',       type: 'summon', name: 'Lightning Fox',  hp: 4, power: 5, summonCost: 6,  art: '🦊' },
  { cardId: 'sum_sentinel',  type: 'summon', name: 'Stone Sentinel', hp: 5, power: 4, summonCost: 6,  art: '🗿' },
  { cardId: 'sum_fox',       type: 'summon', name: 'Lightning Fox',  hp: 4, power: 5, summonCost: 6,  art: '🦊' },
